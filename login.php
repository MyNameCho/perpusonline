...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($user['level'] == 'Administrator') {
            header("Location: dash/dashboard.php"); // Redirect ke dashboard admin
        } else if ($user['level'] == 'Petugas') {
            header("Location: dash/dashboard.php"); // Redirect ke dashboard petugas
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <p>Belum punya akun? <a href="dash/register.php">Daftar di sini</a></p>
        </div>
        <!-- /.login-box-body -->
    </div>
    <!-- /.login-box -->
